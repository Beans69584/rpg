...
public class Region
{
    ...
    public List<int> Connections { get; set; } = new();  // Region indices
...
// Modify the main script to use the procedural generator
var generator = new ProceduralWorldGenerator(seed: 12345);
var config = generator.GenerateWorld();

var builder = new OptimizedWorldBuilder("./World", config);
builder.Build();

Console.WriteLine($"Generated world '{config.Name}' with {config.Regions.Count} regions");
